...
<body ${alert}>
  <div id="wrapper">
          ...
          <div class="span12">
            ...
            <div id="Add" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySigninModalLabel" aria-hidden="true">
              <div class="modal-header">
                ...
                <h4 id="mySigninModalLabel">Add <strong>bank account</strong></h4>
              </div>
              <div class="modal-body">
                <form class="form-horizontal" action="accountManager" method="POST">
                  <div class="control-group">
                    <label class="control-label" for="inputText">Account Name</label>
                    <div class="controls">
					  <select name="option" id="inputText" required>
                  ...
                  <div class="control-group">
                    <label class="control-label" for="inputText1">Account Number</label>
                    <div class="controls">
                      <input type="text" id="inputText1" placeholder="Account Number" name="accountNumber" required>
                    </div>
                  </div>
                  <div class="control-group">
    ...
    <section id="content">
      <div class="container">
        <form class="form-search" action="accountManager" method="POST">
